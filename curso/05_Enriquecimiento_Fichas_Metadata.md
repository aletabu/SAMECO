# Enriquecimiento con fichas de metadatos ("fine-tuning" del RAG)
...
3. Escribe un `.jsonl` por carpeta con el formato de "Documentos con metadatos (RAG)":
   ```json
   {"id": "trabajo-2018-5s", "structData": {"titulo": "…", "anio": 2018, …}, "content": {"mimeType": "application/…", "uri": "gs://bucket/historico/archivo.docx"}}
   ```
